...
#             text_indices = [0] + text_indices + tokenizer.convert_tokens_to_ids(tokenizer.tokenize('target is')) + aspect_indices[1:]
#             text_indices = [0] + text_indices + [2] + tokenizer.convert_tokens_to_ids(tokenizer.tokenize('target is')) + aspect_indices[1:]
            text_indices = [0] + tokenizer.convert_tokens_to_ids(tokenizer.tokenize('target is')) + aspect_indices[1:] + [2] + text_indices[1:]
    
#             text_indices = [0] + [1] + text_indices[1:] + [2] + tokenizer.convert_tokens_to_ids(tokenizer.tokenize('target is')) + aspect_indices[1:]
    
#             text_indices = [0] + tokenizer.convert_tokens_to_ids(tokenizer.tokenize('target')) + text_indices[1:] + [2] + tokenizer.convert_tokens_to_ids(tokenizer.tokenize('target is')) + aspect_indices[1:]
