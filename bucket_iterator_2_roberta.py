...
#                 text_indices = text_indices  + [2] + aspect_indices[1:]
                ...
                # for roberta_gcls
                text_indices = [0] + [50249] + [50250] + text_indices_copy[1:] + [2] + [50249] + [2]
            
            elif self.input_format == 'a2':
                text_indices_copy = text_indices.copy()
                # for roberta_td
#                 text_indices = text_indices  + [2] + aspect_indices[1:]
                
                # for roberta_gcls
                text_indices = [0] + [50249] + [50250] + text_indices_copy[1:] + [2] + [50249] + [50250] + [2]
            
            elif self.input_format == 'a3':
                text_indices_copy = text_indices.copy()
                # for roberta_td
#                 text_indices = text_indices  + [2] + aspect_indices[1:]
                
                # for roberta_gcls
                text_indices = [0] + [50249] + [50250] + text_indices_copy[1:] + [2] + [50249] + tokenizer.convert_tokens_to_ids(tokenizer.tokenize(' ')) + [50250] + [2]
