...
class RobertaEmbeddings(nn.Module):
    ...
    def __init__(self, config, embed_dense = False):
        super().__init__()
...
#         if layer_i %1 == 0:
#             context_layer[:,0,:], context_layer[:,1,:] = self.att_pool_sg([context_layer[:,0,:], context_layer[:,1,:]],
#                                                                           self.dense_s, self.dense_g)
...
class RobertaModel_gcls_m1(RobertaPreTrainedModel):
    ...
    def __init__(self, config, g_pooler, add_pooling_layer=True, automation_type = None, auto_k = None, embed_dense = False,
                 step_threshold = None):
