...
try:
    ...
    _import_structure["modeling_roberta"] = [
        ...
        "RobertaForSequenceClassification_gcls_rpt",
        "RobertaForSequenceClassification_gcls_2",
        "RobertaForSequenceClassification_TD",
        "RobertaForSequenceClassification_lcf",
        "RobertaForSequenceClassification_gcls_td",
        "RobertaForSequenceClassification_lcf_td",
        "RobertaForSequenceClassification_asc_td",
