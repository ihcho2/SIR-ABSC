...
class ReadData:
    def __init__(self, opt):
        ...
        if opt.model_name in ['bert_gcls', 'scls', 'roberta', 'gcls_er', 'gcls_moe', 'roberta_gcls', 'roberta_gcls_2', 'roberta_gcls_moe', 'roberta_td', 'roberta_lcf_td', 'roberta_gcls_td', 'roberta_asc_td']:
